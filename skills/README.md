...
- [scenario-composition/](./scenario-composition/) - Compose reusable multi-role scenarios with explicit boundaries, handoffs, branching, synchronization, and readiness posture.
