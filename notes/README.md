...
- [`orpheum-minor-version-upgrade-task-set.md`](C:/Users/ericw/Projects/orpheum/notes/orpheum-minor-version-upgrade-task-set.md) consolidates the current onboarding, decision-capture, and semantic-review feedback into a bounded implementation sequence for the next minor Orpheum release.
