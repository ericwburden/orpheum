...
5. Treat broader product and architecture artifacts as inherited constraints, then use planning artifacts as the place where the current slice becomes operationally explicit.
